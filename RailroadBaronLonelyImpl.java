...
public class RailroadBaronLonelyImpl implements RailroadBarons{
    ...
    /**
     * constructor for initializing playerList, observerList and creating one player
     * and three computer players
     */
    public RailroadBaronLonelyImpl(){
        playerList = new ArrayList<>();
        playerList.add(new PlayerImpl(Baron.YELLOW, this));
        playerList.add(new ComputerPlayerImpl(Baron.BLUE, this));
        playerList.add(new ComputerPlayerImpl(Baron.GREEN, this));
        playerList.add(new ComputerPlayerImpl(Baron.RED, this));
        ...
        while(true) {
            ...
            if (gameIsOver()) {
                ...
                for(int i = 1; i< playerList.size(); i++){
                    ...
                    int playerListscore = playerList.get(i).getScore();
                    if (winnerscore <= playerListscore){
                ...
                if(!(currentPlayer instanceof ComputerPlayerImpl)) {
                    break;
                }
            }
        }
